<template>
    <Container>
        <div class="app-404page tw-p-10 tw-flex tw-flex-col tw-justify-center tw-items-center">
            <div class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 650 512" id="page-not-found">
                    <path fill="#dbe8ec"
                    ...
                    <path fill="#f9ae2b"
                        d="M221.78248,214.16474A25.03081,25.03081,0,0,1,196.774,239.18431h-93.4501a19.2824,19.2824,0,0,1-4.09924-38.12438,22.24645,22.24645,0,0,1,22.1682-20.77985,21.592,21.592,0,0,1,6.72471,1.07435,35.1018,35.1018,0,0,1,65.34225,8.04976,24.97773,24.97773,0,0,1,28.3227,24.76055Zm0,0">
                    </path>
                    <path fill="#409cb5"
                        d="M384.28,361.08l-18.57849-27.62036a79.998,79.998,0,1,0-23.11361,14.3481l18.11051,26.80388A13.59408,13.59408,0,0,0,384.28,361.08Z">
                    </path>
                    <circle cx="312.733" cy="273.513" r="57.048" fill="#ee781d"></circle>
                    <path fill="#d70018"
                        d="M312.733,216.46549a57.46155,57.46155,0,0,0-8.1389.58762,57.0432,57.0432,0,0,1,0,112.92057,57.046,57.046,0,1,0,8.1389-113.50819Z">
                    </path>
                    ...
                    <line x1="119.225" x2="151.528" y1="119.327" y2="119.327" fill="none" stroke="#b9d4db"
                        stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></line>
                    <line x1="119.225" x2="151.528" y1="128.637" y2="128.637" fill="none" stroke="#b9d4db"
                        stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></line>
                    <line x1="119.225" x2="151.528" y1="137.948" y2="137.948" fill="none" stroke="#b9d4db"
                        stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></line>
                    <line x1="273.595" x2="305.898" y1="395.257" y2="395.257" fill="none" stroke="#b9d4db"
                        stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></line>
                    <line x1="273.595" x2="305.898" y1="404.568" y2="404.568" fill="none" stroke="#b9d4db"
                        stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></line>
                    <line x1="273.595" x2="305.898" y1="413.878" y2="413.878" fill="none" stroke="#b9d4db"
                        stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></line>
                    <line x1="536.115" x2="568.417" y1="271.982" y2="271.982" fill="none" stroke="#b9d4db"
                        stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></line>
                    <line x1="536.115" x2="568.417" y1="281.293" y2="281.293" fill="none" stroke="#b9d4db"
                        stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></line>
                    <line x1="536.115" x2="568.417" y1="290.603" y2="290.603" fill="none" stroke="#b9d4db"
                        stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></line>
            ...
            <div class="title tw-flex tw-flex-col tw-items-center">
                <span>
